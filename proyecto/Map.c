 ...
 *
 * @param capacity El máximo número de elementos que se podrán guardar.
 * @param empty_val El valor que indicará que el slot está vacío. Depende de cada
 * aplicación.
...
/**
 * @brief Inserta un objeto Station en el mapa.
 *
 * @param this        Referencia a un objeto Map.
 * @param nombre      Cadena de texto asociada al registro (key).
 * @param station     Referencia a un objeto Station (value).
 *
 ...
 * @param nombre      Cadena de texto asociada al registro (key).
 *
 * @return La referencia del objeto Station asociado a la clave si está 
 * en almacenado en la tabla, en cualquier otro caso la referenciade a 
 * un objeto Station con valores iniciales "vacios".
 */
